...
@section('content')
    ...
    <div class="w-mob-logo justify-content-center align-items-center w-100">
        <a href="../pages/index.html"><img src="{{asset('media/cropped-cropped-2022-10-18_111454-e1666689446199.png')}}" alt="" width="200px" height="auto"></a>
    </div>
    <div class="cheader">
        <div class="cheader-image">
            <a href="../pages/index.html"><img src="{{asset('media/logo.jpg')}}" alt="" width="200px" height="auto"></a>
        </div>
    ...
    <div class='w-100 d-flex justify-content-center' style="min-height: 50vh;padding: 10%">
        <form action="{{route('client_store_banner')}}" method="post" enctype="multipart/form-data">
            @csrf
