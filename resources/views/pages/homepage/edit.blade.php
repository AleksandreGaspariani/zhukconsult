...
@section('content')
    ...
    <div class='w-100 d-flex justify-content-center' style="min-height: 50vh;padding: 10%">
        <form action="/home/update/post/{{$postId}}" method="post" enctype="multipart/form-data" id="post-form">
            @csrf
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex flex-column justify-content-center align-items-center w-100 text-center">
                    <img src="{{asset('uploads/homeImgs/'.$image)}}" alt="" width="300px" height="auto">
                    <input type="file" name="file" class="form-control w-50" value="{{$image}}">
                </div>
            </div>
