...
@section('content')
    ...
    <div class='w-100 d-flex justify-content-center' style="min-height: 50vh;padding: 10%">
        <form action="/about_us/footer/update/{{$footer[0]->id}}" method="post" enctype="multipart/form-data" id="post-form">
            @csrf
            <div class="d-flex flex-column">
                ...
                <div class="form-floating my-5">
                    <input class="form-control" placeholder="Type Email here" value="{{$footer[0]->footer_email}}" name="email"></input>
