...
@section('content')
    ...
    <div class='w-100 d-flex justify-content-center' style="min-height: 50vh;padding: 10%">
        <form action="{{route('about_us_store')}}" method="post" enctype="multipart/form-data" id="post-form">
            @csrf
            <div class="d-flex flex-column">
                ...
                <div class="d-flex flex-column justify-content-center align-items-center my-2">
                    <input type="text" name="post_email" class="form-control" placeholder="Email">
                </div>
